{
    ...
    "tags": [
        ...
        {
            "name": "ShopListing Personalization"
        },
        {
                ...
                "requestBody": {
                    "content": {
                        "application/json": {
                            "schema": {
                                "type": "object",
                                "required": ["personalization_questions"],
                                "properties": {
                ...
                "responses": {
                    "201": {
                        ...
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/Etsy_Modules_ListingPersonalization_Api_Resources_OpenApi_ListingPersonalization"
                                }
                            }
                        }
                    },
    ...
    "components": {
        ...
        "schemas": {
            ...
            "Etsy_Modules_ListingPersonalization_Api_Resources_OpenApi_ListingPersonalization": {
                "type": "object",
                "x-resource-id": "Etsy_Modules_ListingPersonalization_Api_Resources_OpenApi_ListingPersonalization",
                "properties": {
                    "personalization_questions": {
                        "type": "array",
                        "items": {
                            "$ref": "#/components/schemas/Etsy_Modules_ListingPersonalization_Api_Resources_OpenApi_PersonalizationQuestion"
                        }
                    }
                }
            },
            "Etsy_Modules_ListingPersonalization_Api_Resources_OpenApi_PersonalizationQuestion": {
                "type": "object",
                "x-resource-id": "Etsy_Modules_ListingPersonalization_Api_Resources_OpenApi_PersonalizationQuestion",
                "properties": {
                    "question_id": {
                        "type": "integer",
                        "format": "int64",
